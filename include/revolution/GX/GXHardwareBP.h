...
/**
 * @name BP register 0x0 - GenMode
 */
/**@{*/
//! @name NUMTEX [28:31] (4) - Active texture count
/**@{*/
...
/**@}*/
//! @name NUMCOLORS [25:27] (3) - Color/channel count
/**@{*/
...
/**@}*/
//! @name COPLANAR [12:12] (1) - Toggle co-planar ("Z freeze" according to
//! Dolphin)
/**@{*/
...
/**
 * @name BP structure - IndMtxA
 */
/**@{*/
//! @name M00 [21:31] (11) - Texture offset matrix #0 [0][0]
/**@{*/
...
/**@}*/
//! @name M10 [10:20] (11) - Texture offset matrix #0 [1][0]
/**@{*/
...
/**@}*/
//! @name EXP [8:9] (2) - Bits 0-1 of scaling exponent #0 (2^x)
/**@{*/
...
/**
 * @name BP structure - IndMtxB
 */
/**@{*/
//! @name M01 [21:31] (11) - Texture offset matrix #0 [0][1]
/**@{*/
...
/**@}*/
//! @name M11 [10:20] (11) - Texture offset matrix #0 [1][1]
/**@{*/
...
/**@}*/
//! @name EXP [8:9] (2) - Bits 2-3 of scaling exponent #0 (2^x)
/**@{*/
...
/**
 * @name BP structure - IndMtxC
 */
/**@{*/
//! @name M02 [21:31] (11) - Texture offset matrix #0 [0][2]
/**@{*/
...
/**@}*/
//! @name M12 [10:20] (11) - Texture offset matrix #0 [1][2]
/**@{*/
...
/**@}*/
//! @name EXP [8:9] (2) - Bit 4 of scaling exponent #0 (2^x)
/**@{*/
...
/**
 * @name BP register 0xF - IndIMask
 */
/**@{*/
//! @name IMASK [24:31] (8) - Indirect mask for textures
/**@{*/
...
/**
 * @name BP structure - IndTevStage
 */
/**@{*/
//! @name STAGE [30:31] (2) - Indirect texture stage ID
/**@{*/
...
/**@}*/
//! @name FORMAT [28:29] (2) - Indirect texture format
/**@{*/
...
/**@}*/
//! @name BIAS [25:27] (3) - Indirect texture bias
/**@{*/
...
/**@}*/
//! @name ALPHA [23:24] (2) - Indirect texture alpha
/**@{*/
...
/**@}*/
//! @name MTX [19:22] (4) - Indirect texture matrix
/**@{*/
...
/**@}*/
//! @name WRAPS [16:18] (3) - S component wrap factor
/**@{*/
...
/**@}*/
//! @name WRAPT [13:15] (3) - T component wrap factor
/**@{*/
...
/**@}*/
//! @name UTCLOD [12:12] (1) - Whether to use unmodified texcoords for mipmaps
/**@{*/
...
/**@}*/
//! @name ADDPREV [11:11] (1) - Whether to add in results from previous tev
//! stage
/**@{*/
...
/**
 * @name BP register 0x20 - scissorTL
 */
/**@{*/
//! @name TOP [21:31] (11) - Top component
/**@{*/
...
/**@}*/
//! @name LEFT [9:19] (11) - Left component
/**@{*/
...
/**
 * @name BP register 0x21 - scissorBR
 */
/**@{*/
//! @name BOT [21:31] (11) - Bottom component
/**@{*/
...
/**@}*/
//! @name RIGHT [9:19] (11) - Right component
/**@{*/
...
/**
 * @name BP register 0x22 - linePtWidth
 */
/**@{*/
//! @name LINESZ [24:31] (8) - Line size/width
/**@{*/
...
/**@}*/
//! @name POINTSZ [16:23] (8) - Point size
/**@{*/
...
/**@}*/
//! @name LINEOFS [13:15] (3) - Line offset
/**@{*/
...
/**@}*/
//! @name POINTOFS [10:12] (3) - Point offset
/**@{*/
...
/**@}*/
//! @name ADJUST_AR [9:9] (1) - Interlacing: adjust for pixels having aspect
//! ratio of 1/2
/**@{*/
...
/**
 * @name BP register 0x25 - ras1_ss0
 */
/**@{*/
//! @name S0 [28:31] (4) - S-component scale (stage 0)
/**@{*/
...
/**@}*/
//! @name T0 [24:27] (4) - T-component scale (stage 0)
/**@{*/
...
/**@}*/
//! @name S1 [20:23] (4) - S-component scale (stage 1)
/**@{*/
...
/**@}*/
//! @name T1 [16:19] (4) - T-component scale (stage 1)
/**@{*/
...
/**
 * @name BP register 0x26 - ras1_ss1
 */
/**@{*/
//! @name S2 [28:31] (4) - S-component scale (stage 2)
/**@{*/
...
/**@}*/
//! @name T2 [24:27] (4) - T-component scale (stage 2)
/**@{*/
...
/**@}*/
//! @name S3 [20:23] (4) - S-component scale (stage 3)
/**@{*/
...
/**@}*/
//! @name T3 [16:19] (4) - T-component scale (stage 3)
/**@{*/
...
/**
 * @name BP register 0x27 - ras1_iref
 */
/**@{*/
//! @name MAP0 [29:31] (3) - Texmap id (stage 0)
/**@{*/
...
/**@}*/
//! @name TXC0 [26:28] (3) - Texcoord ID (stage 0)
/**@{*/
...
/**@}*/
//! @name MAP1 [23:25] (3) - Texmap id (stage 1)
/**@{*/
...
/**@}*/
//! @name TXC1 [20:22] (3) - Texcoord ID (stage 1)
/**@{*/
...
/**@}*/
//! @name MAP2 [17:19] (3) - Texmap id (stage 2)
/**@{*/
...
/**@}*/
//! @name TXC2 [14:16] (3) - Texcoord ID (stage 2)
/**@{*/
...
/**@}*/
//! @name MAP3 [11:13] (3) - Texmap id (stage 3)
/**@{*/
...
/**@}*/
//! @name TXC3 [8:10] (3) - Texcoord ID (stage 3)
/**@{*/
...
/**
 * @name BP structure - su_ssize
 */
/**@{*/
//! @name USELINEOFS [13:13] (1)
/**@{*/
...
/**
 * @name BP register 0x40 - ZMode
 */
/**@{*/
//! @name TEST_ENABLE [31:31] (1)
/**@{*/
...
/**
 * @name BP register 0x41 - BlendMode
 */
/**@{*/
//! @name BLEND_ENABLE [31:31] (1)
/**@{*/
...
/**
 * @name BP register 0x42 - DstAlpha
 */
/**@{*/
//! @name ALPHA [24:31] (8)
/**@{*/
...
/**
 * @name BP register 0x43 - ZControl
 */
/**@{*/
//! @name PIXEL_FMT [29:31] (3)
/**@{*/
...
/**@}*/
//! @name BEFORE_TEX [25:25] (1) - Determines whether Z-buffering occurs before
//! or after texturing
/**@{*/
...
/**
 * @name BP register 0x44 - FieldMask
 */
/**@{*/
//! @name ODD [31:31] (1) - Whether to write odd fields to the EFB
/**@{*/
...
/**@}*/
//! @name EVEN [30:30] (1) - Whether to write even fields to the EFB
/**@{*/
...
/**
 * @name BP register 0x59 - ScissorOffset
 */
/**@{*/
//! @name OX [22:31] (10)
/**@{*/
...
/**
 * @name BP register 0x68 - FieldMode
 */
/**@{*/
//! @name TEX_LOD [31:31] (1) - Adjust vertex tex LOD computation to account for
//! interlacing
/**@{*/
...
/**
 * @name BP register 0xE8 - FogRange
 */
/**@{*/
//! @name CENTER [22:31] (10)
/**@{*/
...
/**
 * @name BP register 0xEE - FogParam0
 */
/**@{*/
//! @name A_MANT [21:31] (11)
/**@{*/
...
/**
 * @name BP register 0xEF - FogParam1
 */
/**@{*/
//! @name B_MAG [8:31] (24)
/**@{*/
...
/**
 * @name BP register 0xF0 - FogParam2
 */
/**@{*/
//! @name B_SHIFT [27:31] (5)
/**@{*/
...
/**
 * @name BP register 0xF1 - FogParam3
 */
/**@{*/
//! @name C_MANT [21:31] (11)
/**@{*/
...
/**
 * @name BP register 0xF2 - FogColor
 */
/**@{*/
//! @name RGB [8:31] (24)
/**@{*/
